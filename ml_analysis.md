...
Train a model on the training set and check the performance of the model by making predictions on the validation set.
...
Not surprisingly the model performs well on the dataset it was trained on and accurately predicts the outcome class
